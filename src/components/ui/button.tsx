  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground rounded-full hover:shadow-glow hover:scale-105 font-semibold tracking-wide uppercase",
        heroOutline: "border-2 border-hero-foreground/30 text-hero-foreground rounded-full hover:bg-hero-foreground/10 hover:border-hero-foreground font-semibold tracking-wide uppercase",
        cta: "bg-gradient-primary text-primary-foreground rounded-full hover:shadow-glow hover:scale-105 font-semibold tracking-wide",
      },
      size: {
